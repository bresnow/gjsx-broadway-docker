...
function instance(val, exp, msg) {
  ...
  assert(
    ...
    "instance",
    false,
    `Expected value to be an instance of ${name}`,
    msg,
  );
}
...
function match(val, exp, msg) {
  if (typeof exp === "string") {
    assert(
      ...
      "match",
      false,
      `Expected value to include "${exp}" substring`,
      msg,
    );
  } else {
    assert(
      ...
      "match",
      false,
      `Expected value to match \`${String(exp)}\` pattern`,
      msg,
    );
  }
}
...
function fixture(val, exp, msg) {
  ...
  assert(
    ...
    "fixture",
    lineNums,
    "Expected value to match fixture:",
    msg,
  );
}
