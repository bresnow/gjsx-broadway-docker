...
return {
display: (bool) => bool && Gtk.StyleContext.add_provider_for_display(
...
function promiseTask(object, method, finishMethod, ...args) {
...
function once(object, signal, options = {
error: "",
timeout: -1
}) {
let promise;
...
function writeTextFileSync(file, contents) {
