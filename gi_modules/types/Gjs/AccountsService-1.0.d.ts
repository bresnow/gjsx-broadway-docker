...
export namespace AccountsService {
  ...
  interface User {
    ...
    connect_after(
      sigName: "changed",
      callback: User_ChangedSignalCallback
    ): number;
    emit(sigName: "changed", ...args: any[]): void;
    connect(
      sigName: "sessions-changed",
      callback: User_SessionsChangedSignalCallback
    ): number;
    connect_after(
      sigName: "sessions-changed",
      callback: User_SessionsChangedSignalCallback
    ...
    connect(
      sigName: "notify::account-type",
      callback: ($obj: User, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::account-type",
      callback: ($obj: User, pspec: GObject.ParamSpec) => void
    ...
    connect(
      sigName: "notify::automatic-login",
      callback: ($obj: User, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::automatic-login",
    ...
    connect(
      sigName: "notify::login-frequency",
      callback: ($obj: User, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::login-frequency",
  ...
  interface UserManager {
    ...
    connect(
      sigName: "user-added",
      callback: UserManager_UserAddedSignalCallback
    ): number;
    connect_after(
      sigName: "user-added",
      callback: UserManager_UserAddedSignalCallback
    ...
    connect(
      sigName: "user-changed",
      callback: UserManager_UserChangedSignalCallback
    ): number;
    connect_after(
      sigName: "user-changed",
      callback: UserManager_UserChangedSignalCallback
    ...
    connect(
      sigName: "user-is-logged-in-changed",
      callback: UserManager_UserIsLoggedInChangedSignalCallback
    ): number;
    connect_after(
      sigName: "user-is-logged-in-changed",
      callback: UserManager_UserIsLoggedInChangedSignalCallback
    ...
    connect(
      sigName: "user-removed",
      callback: UserManager_UserRemovedSignalCallback
    ): number;
    connect_after(
      sigName: "user-removed",
      callback: UserManager_UserRemovedSignalCallback
    ...
    connect(
      sigName: "notify::exclude-usernames-list",
      callback: ($obj: UserManager, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::exclude-usernames-list",
      callback: ($obj: UserManager, pspec: GObject.ParamSpec) => void
    ...
    connect(
      sigName: "notify::has-multiple-users",
      callback: ($obj: UserManager, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::has-multiple-users",
    ...
    connect(
      sigName: "notify::include-usernames-list",
      callback: ($obj: UserManager, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::include-usernames-list",
