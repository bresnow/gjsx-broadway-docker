...
export namespace Accounts {
  ...
  interface Account_ConstructProps
    extends Gio.Initable_ConstructProps,
      GObject.Object_ConstructProps {
  ...
  interface Account extends Gio.Initable {
    ...
    get_value(
      key: string,
      value: any
    ): [/* returnType */ SettingSource, /* value */ any];
    /**
    ...
    get_variant(
      key: string
    ): [/* returnType */ GLib.Variant, /* source */ SettingSource];
    /**
    ...
    connect(
      sigName: "deleted",
      callback: Account_DeletedSignalCallback
    ): number;
    connect_after(
      sigName: "deleted",
      callback: Account_DeletedSignalCallback
    ...
    connect(
      sigName: "display-name-changed",
      callback: Account_DisplayNameChangedSignalCallback
    ): number;
    connect_after(
      sigName: "display-name-changed",
      callback: Account_DisplayNameChangedSignalCallback
    ...
    connect(
      sigName: "enabled",
      callback: Account_EnabledSignalCallback
    ): number;
    connect_after(
      sigName: "enabled",
      callback: Account_EnabledSignalCallback
    ...
    connect(
      ...
      callback: ($obj: Account, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::display-name",
      callback: ($obj: Account, pspec: GObject.ParamSpec) => void
  ...
  interface AccountService_ConstructProps
  ...
  interface AccountService {
    ...
    connect(
      sigName: "changed",
      callback: AccountService_ChangedSignalCallback
    ): number;
    connect_after(
      sigName: "changed",
      callback: AccountService_ChangedSignalCallback
    ...
    connect(
      sigName: "enabled",
      callback: AccountService_EnabledSignalCallback
    ): number;
    connect_after(
      sigName: "enabled",
      callback: AccountService_EnabledSignalCallback
    ...
    connect(
      sigName: "notify::account",
      callback: ($obj: AccountService, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::account",
      callback: ($obj: AccountService, pspec: GObject.ParamSpec) => void
  ...
  class AccountService extends GObject.Object {
     ...
     */
    static settings_iter_next(
      iter: AccountSettingIter
    ): [/* returnType */ boolean, /* key */ string, /* value */ any];
  }

  interface Manager_ConstructProps
    extends Gio.Initable_ConstructProps,
      GObject.Object_ConstructProps {
  ...
  interface Manager extends Gio.Initable {
    ...
    connect(
      sigName: "account-created",
      callback: Manager_AccountCreatedSignalCallback
    ): number;
    connect_after(
      sigName: "account-created",
      callback: Manager_AccountCreatedSignalCallback
    ...
    connect(
      sigName: "account-deleted",
      callback: Manager_AccountDeletedSignalCallback
    ): number;
    connect_after(
      sigName: "account-deleted",
      callback: Manager_AccountDeletedSignalCallback
    ...
    connect(
      sigName: "account-updated",
      callback: Manager_AccountUpdatedSignalCallback
    ): number;
    connect_after(
      sigName: "account-updated",
      callback: Manager_AccountUpdatedSignalCallback
    ...
    connect(
      sigName: "enabled-event",
      callback: Manager_EnabledEventSignalCallback
    ): number;
    connect_after(
      sigName: "enabled-event",
      callback: Manager_EnabledEventSignalCallback
    ...
    connect(
      sigName: "notify::abort-on-db-timeout",
      callback: ($obj: Manager, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::abort-on-db-timeout",
      callback: ($obj: Manager, pspec: GObject.ParamSpec) => void
