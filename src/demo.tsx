...
}, class Demo extends Gtk.Box {
  video: Gtk.Video
  picture: Gtk.Picture
  _init() {
    super._init();
    this.video.set_file(Gio.File.new_for_path(__dirname + "/assets/video/640.mp4"));
    this.picture.set_file(Gio.File.new_for_path(__dirname + "/assets/images/mrs_arnold.jpg"));
  };
