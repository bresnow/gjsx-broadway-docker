...
export const Video = GObject.registerClass({ GTypeName: "Video" }, class extends Gtk.Box {
    ...
    _init() {
        ...
        try {
            ...
            let lonelyShades = Gio.File.new_for_path(__dirname + '/assets/video/shades.webm');
